...
public class SingleMustEmptyEdge extends AtomicProposition {
     ...
     * @param mustEmptySite
     */
    public SingleMustEmptyEdge(final int mustEmptySite) {
    ...
    public boolean matches(final State state) {
        return state.containerStates()[0].emptyChunkSetEdge().get(mustEmptySite);
    }
    ...
    public boolean equals(final Object obj) {
        ...
        final SingleMustEmptyEdge other = (SingleMustEmptyEdge) obj;
        return (mustEmptySite == other.mustEmptySite);
    }

    @Override
    public String toString() {
        return "[Edge " + mustEmptySite + " must be empty]";
    }
