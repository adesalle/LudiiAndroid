...
public class SingleMustEmptyVertex extends AtomicProposition {
     ...
     * @param mustEmptySite
     */
    public SingleMustEmptyVertex(final int mustEmptySite) {
    ...
    public boolean matches(final State state) {
        return state.containerStates()[0].emptyChunkSetVertex().get(mustEmptySite);
    }
    ...
    public boolean equals(final Object obj) {
        ...
        final SingleMustEmptyVertex other = (SingleMustEmptyVertex) obj;
        return (mustEmptySite == other.mustEmptySite);
    }

    @Override
    public String toString() {
        return "[Vertex " + mustEmptySite + " must be empty]";
    }
