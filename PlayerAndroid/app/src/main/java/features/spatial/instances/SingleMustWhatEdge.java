...
public class SingleMustWhatEdge extends AtomicProposition {
     ...
     * @param chunkSize
     */
    public SingleMustWhatEdge(final int mustWhatSite, final int mustWhatValue, final int chunkSize) {
    ...
    public boolean equals(final Object obj) {
        ...
        final SingleMustWhatEdge other = (SingleMustWhatEdge) obj;
        return (mask == other.mask && matchingWord == other.matchingWord && wordIdx == other.wordIdx);
    }

    @Override
    public String toString() {
        return "[Edge " + site + " must contain " + value + "]";
    }
