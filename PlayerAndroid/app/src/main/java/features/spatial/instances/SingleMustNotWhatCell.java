 ...
 */
public class SingleMustNotWhatCell extends AtomicProposition {
     ...
     * @param chunkSize
     */
    public SingleMustNotWhatCell(final int mustNotWhatSite, final int mustNotWhatValue, final int chunkSize) {
    ...
    public boolean equals(final Object obj) {
        ...
        final SingleMustNotWhatCell other = (SingleMustNotWhatCell) obj;
        return (mask == other.mask && matchingWord == other.matchingWord && wordIdx == other.wordIdx);
    }

    @Override
    public String toString() {
        return "[Cell " + site + " must NOT contain " + value + "]";
    }
