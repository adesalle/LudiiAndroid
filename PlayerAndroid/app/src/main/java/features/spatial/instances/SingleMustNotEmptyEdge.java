...
public class SingleMustNotEmptyEdge extends AtomicProposition {
     ...
     */
    public SingleMustNotEmptyEdge(final int mustNotEmptySite) {
    ...
    public boolean matches(final State state) {
        return !state.containerStates()[0].emptyChunkSetEdge().get(mustNotEmptySite);
    }
    ...
    public boolean equals(final Object obj) {
        ...
        final SingleMustNotEmptyEdge other = (SingleMustNotEmptyEdge) obj;
        return (mustNotEmptySite == other.mustNotEmptySite);
    }

    @Override
    public String toString() {
        return "[Edge " + mustNotEmptySite + " must NOT be empty]";
    }
