...
public class SingleMustNotEmptyCell extends AtomicProposition {
     ...
     */
    public SingleMustNotEmptyCell(final int mustNotEmptySite) {
    ...
    public boolean matches(final State state) {
        return !state.containerStates()[0].emptyChunkSetCell().get(mustNotEmptySite);
    }
    ...
    public boolean equals(final Object obj) {
        ...
        final SingleMustNotEmptyCell other = (SingleMustNotEmptyCell) obj;
        return (mustNotEmptySite == other.mustNotEmptySite);
    }

    @Override
    public String toString() {
        return "[Cell " + mustNotEmptySite + " must NOT be empty]";
    }
