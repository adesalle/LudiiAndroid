...
public class BipartiteGraphFeatureInstanceSet {
    ...
    (
        ...
        @SuppressWarnings("unchecked") final List<List<DisjunctiveClause>>[] lists = new List[]{ungeneralisedDisjunctions, generalisedDisjunctions};
...
//			System.out.println();
    ...
    // Do NOT remove SuppressWarning: sometimes use this for debugging!
