...
public enum SiteType {
    ...
    (
        ...
        if (type != null) {
            switch (type) {
                case Vertex:
                    gameFlags |= (GameType.Vertex | GameType.Graph);
                    break;
                case Edge:
                    gameFlags |= (GameType.Edge | GameType.Graph);
                    break;
                case Cell:
                    gameFlags |= GameType.Cell;
                    break;
            }
        }
        return gameFlags;
    ...
    (
        ...
        if (type != null) {
            switch (type) {
                case Vertex:
                    concepts.set(Concept.Vertex.id(), true);
                    break;
                case Edge:
                    concepts.set(Concept.Edge.id(), true);
                    break;
                case Cell:
                    concepts.set(Concept.Cell.id(), true);
                    break;
            }
        }
        return concepts;
