 ...
 */
public class EvalMCTSVariantsScriptsGenLemaitre4PublicGames {
    /**
     ...
     */
    private static final int MAX_WALL_TIME = 800;
     ...
     */
    private EvalMCTSVariantsScriptsGenLemaitre4PublicGames() {
        // Do nothing
    }
    ...
    private static void generateScripts(final CommandLineArgParse argParse) {
        ...
        while (processIdx < processDataList.size()) {
            ...
            try (final PrintWriter writer = new UnixPrintWriter(new File(scriptsDir + jobScriptFilename), "UTF-8")) {
                ...
                writer.println("#SBATCH -J EvalMCTSVariantsPublic");
                writer.println("#SBATCH -p batch");
                writer.println("#SBATCH -o /home/ucl/ingi/" + userName + "/EvalMCTSVariantsPublic/Out/Out_%J.out");
                writer.println("#SBATCH -e /home/ucl/ingi/" + userName + "/EvalMCTSVariantsPublic/Err/Err_%J.err");
                        ...
                        (
                                StringRoutines.join
                                        (
                                                ...
                                                "-XX:HeapDumpPath=" + StringRoutines.quote("/home/ucl/ingi/" + userName + "/EvalMCTSVariantsPublic/Err/java_pid%p.hprof"),
                                                "-da",
                                                "-dsa",
                                                "-XX:+UseStringDeduplication",
                                                "-jar",
                                                StringRoutines.quote("/home/ucl/ingi/" + userName + "/EvalMCTSVariantsPublic/Ludii.jar"),
                    ...
                    final TrialsBatchToRun trialsBatch =
                            new TrialsBatchToRun
                                    (
                                            ...
                                            30, 650, 1.0, 75000, 10,
                                            "/globalscratch/ucl/ingi/" + userName + "/EvalMCTSVariantsPublic/Out/" + filepathsGameName + filepathsRulesetName + "/" + processData.callID,
                                            processData.agentStrings,
                                            false, false, true, false
                                    );

                    trialsBatch.toJson(scriptsDir + "TrialsBatch_" + processData.callID + ".json");
                    writer.print(" " + "/home/ucl/ingi/" + userName + "/EvalMCTSVariantsPublic/Scripts/" + "TrialsBatch_" + processData.callID + ".json");
                        ...
                        (
                                " " + StringRoutines.join
                                        (
                                                " ",
                                                ">",
                                                "/home/ucl/ingi/" + userName + "/EvalMCTSVariantsPublic/Out/Out_${SLURM_JOB_ID}" + ".out",
                                                "2>",
                                                "/home/ucl/ingi/" + userName + "/EvalMCTSVariantsPublic/Err/Err_${SLURM_JOB_ID}" + ".err",
