...
public abstract class AI {
     ...
     */
    public static final ContextCopyInterface STANDARD_CONTEXT_COPY = (final Context context) -> {
        return new Context(context);
    };
    /**
     * Functor that creates copies of contexts including seed copying, for RNG cheats
     */
    public static final ContextCopyInterface RNG_CHEAT_COPY = (final Context context) -> {
