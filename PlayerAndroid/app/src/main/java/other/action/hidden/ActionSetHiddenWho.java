...
public final class ActionSetHiddenWho extends BaseAction {
    ...
    public Action apply(final Context context, final boolean store) {
        ...
        if (!alreadyApplied) {
            ...
            previousValue = cs.isHiddenWho(who, to, level, type);
            previousType = type;
            alreadyApplied = true;
        }
    ...
    public Action undo(final Context context, boolean discard) {
        context.containerState(context.containerId()[to]).setHiddenWho(context.state(), who, to, level, previousType, previousValue);
        return this;
    }
    ...
    public ActionType actionType() {
        return ActionType.SetHiddenWho;
    }
