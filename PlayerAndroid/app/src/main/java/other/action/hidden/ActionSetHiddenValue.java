 ...
 * @author Eric.Piette
 */
public final class ActionSetHiddenValue extends BaseAction {
     ...
     */
    public ActionSetHiddenValue(final int who, final SiteType type, final int to, final int level, final boolean value) {
        this.type = type;
        this.to = to;
        this.who = who;
        this.level = level;
    ...
    /**
     * Reconstructs an ActionSetHiddenValue object from a detailed String (generated
     * using toDetailedString())
     *
     * @param detailedString
     */
    public ActionSetHiddenValue(final String detailedString) {
        assert (detailedString.startsWith("[SetHiddenValue:"));
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof ActionSetHiddenValue))
            return false;

        final ActionSetHiddenValue other = (ActionSetHiddenValue) obj;
    ...
    public ActionType actionType() {
        return ActionType.SetHiddenValue;
    }
