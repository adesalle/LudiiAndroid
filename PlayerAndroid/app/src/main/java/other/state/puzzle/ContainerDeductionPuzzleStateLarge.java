...
public class ContainerDeductionPuzzleStateLarge extends ContainerDeductionPuzzleState {
    ...
    public void resetVariable(final SiteType type, final int var, final int numValues) {
        switch (type) {
            case Vertex:
                ...
                break;
            case Edge:
                edgesList.get(var).set(0, nbValuesEdge, true);
                break;
            case Cell:
                cellsList.get(var).set(0, nbValuesCell, true);
                break;
            default:
                verticeList.get(var - offset).set(0, nbValuesVert, true);
                break;
    ...
    public BitSet values(final SiteType type, final int var) {
        switch (type) {
            ...
            case Edge:
                return edgesList.get(var);
            case Cell:
                return cellsList.get(var);
            default:
                return verticeList.get(var - offset);
        }
    }
    ...
    /**
     * @param var
     * @param value Set a value to the variable for the face.
     */
    @Override
    ...
    /**
     * @param var
     * @param value Toggle a value to the variable for the face.
     */
    @Override
