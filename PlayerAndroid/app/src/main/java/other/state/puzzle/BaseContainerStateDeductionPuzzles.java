...
public abstract class BaseContainerStateDeductionPuzzles implements ContainerState {
    ...
    /**
     * @param var
     * @param value Set a value to the variable for the vert.
     */
    ...
    /**
     * @param var
     * @param value Set a value to the variable for the edge.
     */
    public abstract void setEdge(final int var, final int value);

    /**
     * @param var
     * @param value Toggle a value to the variable for the edge.
     */
