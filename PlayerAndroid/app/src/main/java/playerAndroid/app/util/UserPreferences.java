...
public class UserPreferences
{
    ...
    public static void savePreferences(final PlayerApp app)
    {
        ...
        try
        {
            ...
            // Settings Desktop
            //json.put("FrameMaximizedBoth", AndroidApp.frame().getExtendedState() == Frame.MAXIMIZED_BOTH);
            ...
            json.put("FrameWidth", AndroidApp.frame().getWidth());
            json.put("FrameHeight", AndroidApp.frame().getHeight());
            //json.put("FrameLocX", AndroidApp.frame().getLocation().x);
            //json.put("FrameLocY", AndroidApp.frame().getLocation().y);
            ...
            //final File selectedLoadTrialFile = AndroidApp.loadTrialFileChooser().getSelectedFile();
            ...
            //final File selectedLoadTournamentFile = AndroidApp.loadTournamentFileChooser().getSelectedFile();
    ...
    public static void loadPreferences(final PlayerApp app)
    {
        ...
        try (final InputStream inputStream = Files.newInputStream(new File("." + File.separator + "ludii_preferences.json").toPath()))
        {
...
//				throw new Exception("Incorrect version number");
            ...
            //AndroidApp.setLastSelectedJsonPath(json.optString("LastSelectedJsonFile", AndroidApp.lastSelectedJsonPath()));
            //AndroidApp.setLastSelectedJarPath(json.optString("LastSelectedJarFile", AndroidApp.lastSelectedJarPath()));
            //AndroidApp.setLastSelectedAiDefPath(json.optString("LastSelectedAiDefFile", AndroidApp.lastSelectedAiDefPath()));
            //AndroidApp.setLastSelectedGamePath(json.optString("LastSelectedGameFile", AndroidApp.lastSelectedGamePath()));
            //AndroidApp.setLastSelectedSaveGamePath(json.optString("LastSelectedSaveGameFile", AndroidApp.lastSelectedSaveGamePath()));
            //AndroidApp.setLastSelectedLoadTrialPath(json.optString("LastSelectedLoadTrialFile", AndroidApp.lastSelectedLoadTrialPath()));
            //AndroidApp.setLastSelectedLoadTournamentPath(json.optString("LastSelectedLoadTournamentFile", AndroidApp.lastSelectedLoadTournamentPath()));
