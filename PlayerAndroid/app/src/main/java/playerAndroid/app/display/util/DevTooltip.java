...
import androidUtils.swing.ToolTipManager;
...
public class DevTooltip
{
    ...
    public static void displayToolTipMessage(final PlayerApp app, final Point pt)
    {
        ...
        for (final ToolButton toolButton : AndroidApp.view().toolPanel().buttons)
        {
            if (toolButton != null && toolButton.mouseOver())
            {
                ...
                toolTipMessage += "</html>";
                AndroidApp.view().setToolTipText(toolTipMessage);
                toolTipShown = true;
                break;
            }
        }
        ...
        )
        {
            ...
            {
                //e.printStackTrace();
                AndroidApp.view().setToolTipText(null);
                return;
            }
        }
