...
public class EditorPickerPanel extends JPanel {
    ...
    public EditorPickerPanel(VisualEditorPanel visualEditorPanel) {
        ...
        gameEditorBtn.addActionListener(new ActionListener() {
            @Override
        ...
        defineEditorBtn.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        textEditorBtn.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
