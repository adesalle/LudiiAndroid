...
public class ReconstructionDialog extends JDialog
{
	...
	public ReconstructionDialog(final PlayerApp app)
	{
		...
		final ActionListener buttonListenerReconstruction = new ActionListener()
		{
			...
			{
				final JFileChooser fileChooser = AndroidApp.gameFileChooser();
				fileChooser.setFileSelectionMode(JFileChooser.FILES_ONLY);
				fileChooser.setDialogTitle("Select input reconstruction.");
				final int gameReturnVal = fileChooser.showOpenDialog(AndroidApp.frame());
		...
		getContentPane().add(buttonPane, BorderLayout.SOUTH);
		{
			...
			final ActionListener okButtonListener = new ActionListener()
			{
				...
				public void actionPerformed(final ActionEvent arg0)
				{
					try
					{
						final String outputPath = String.valueOf(txtOutput.getText());
						final String selectedLudPath = String.valueOf(txtInput.getText());
						final String dataPath = String.valueOf(txtData.getText());
						final Integer numRecons = Integer.valueOf(String.valueOf(textFieldMaxRecons.getText()));
						final Integer maxTries = Integer.valueOf(String.valueOf(textFieldMaxTries.getText()));
						Double csnScore = Double.valueOf(String.valueOf(textFieldCSNScore.getText()));
						Double conceptScore = Double.valueOf(String.valueOf(textFieldConceptScore.getText()));
