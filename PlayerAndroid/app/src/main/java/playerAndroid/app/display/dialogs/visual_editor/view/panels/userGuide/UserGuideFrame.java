package playerAndroid.app.display.dialogs.visual_editor.view.panels.userGuide;
...
public class UserGuideFrame extends JFrame
{
    ...
    public UserGuideFrame()
    {
        ...
        setBackground(new ColorDrawable(DesignPalette.BACKGROUND_EDITOR().toArgb()));
        ...
        closeButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) {
                dispatchEvent(new WindowEvent(UserGuideFrame.this, WindowEvent.WINDOW_CLOSING));
            }
        });
