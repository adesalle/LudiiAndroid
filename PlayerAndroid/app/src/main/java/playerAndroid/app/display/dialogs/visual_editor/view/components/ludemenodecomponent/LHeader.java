...
public class LHeader extends JComponent
{
    ...
    public LHeader(LudemeNodeComponent ludemeNodeComponent)
    {
        ...
        title.setForeground(new ColorDrawable(DesignPalette.FONT_LUDEME_TITLE_COLOR().toArgb()));
        ...
        if(LN.clauses() != null && LN.clauses().size() > 1) {
            ...
            clauseBtn.addActionListener(new ActionListener() {
                @Override
        ...
        for(Symbol s : symbolClauseMap.keySet())
        {
            ...
            else
            {
                ...
                for(int j = 0; j < clauses.size(); j++)
                {
                    ...
                    subitems[j].addActionListener(new ActionListener() {
                        @Override
                        public void actionPerformed(ActionEvent event) {
    ...
    public void paintComponent(Graphics g)
    {
        ...
        if(title.getForeground() != new ColorDrawable(DesignPalette.FONT_LUDEME_TITLE_COLOR().toArgb()))
        {
            title.setForeground(new ColorDrawable(DesignPalette.FONT_LUDEME_TITLE_COLOR().toArgb()));
        }
        ...
        {
            Font fontMetrics = title.getFontMetrics();
