package playerAndroid.app.display.dialogs.visual_editor.view.panels.editor.tabPanels;
...
import playerAndroid.app.display.dialogs.visual_editor.LayoutManagement.DFBoxDrawing;
...
import playerAndroid.app.display.dialogs.visual_editor.LayoutManagement.NodePlacementRoutines;
...
public class LayoutSettingsPanel extends JPanel
{
    ...
    private LayoutSettingsPanel()
    {
        ...
        alignX.addActionListener(        new ActionListener() {
            @Override
        ...
        alignY.addActionListener(        new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) {
        ...
        fixNodes.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) {
        ...
        unfixNodes.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) {
        ...
        closeLayoutTab.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) {
     ...
     */
    private static void addAButton(JButton button, ViewGroup container)
    {
