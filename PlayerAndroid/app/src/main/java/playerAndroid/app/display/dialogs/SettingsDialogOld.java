...
public class SettingsDialogOld extends JDialog
{
	...
	static SettingsDialogOld dialog;
	...
	public static void createAndShowGUI(final PlayerApp app)
	{
		try
		{
			dialog = new SettingsDialogOld(app);
	 ...
	 * Create the dialog.
	 */
	public SettingsDialogOld(final PlayerApp app)
	{
		...
		final ArrayList<String> aiStringsBlank = AndroidGUIUtil.getAIDropdownStrings(app, true);
		aiStringsBlank.add("-");
		...
		final DocumentListener documentListenerMaxTurns = new DocumentListener()
		{
			...
			private void update(final DocumentEvent documentEvent)
			{
				...
				try
				{
					numberTurns = Integer.parseInt(textFieldMaximumNumberOfTurns.getText().toString());
				}
				catch (final Exception e)
				{
					// not an integer;
		...
		final DocumentListener documentListenerTickLength = new DocumentListener()
		{
			...
			private void update(final DocumentEvent documentEvent)
			{
				...
				try
				{
					tickLength = Double.parseDouble(textFieldTickLength.getText().toString());
				}
				catch (final Exception e)
				{
					// not an integer;
		...
		final DocumentListener documentListenerTabFontSize = new DocumentListener()
		{
			...
			private void update(final DocumentEvent documentEvent)
			{
				...
				try
				{
					tabFontSize = Integer.parseInt(textFieldTabFontSize.getText().toString());
				}
				catch (final Exception e)
				{
					// not an integer;
		...
		final DocumentListener documentListenerEditorFontSize = new DocumentListener()
		{
			...
			private void update(final DocumentEvent documentEvent)
			{
				...
				try
				{
					editorFontSize = Integer.parseInt(textFieldEditorFontSize.getText().toString());
				}
				catch (final Exception e)
				{
					// not an integer;
