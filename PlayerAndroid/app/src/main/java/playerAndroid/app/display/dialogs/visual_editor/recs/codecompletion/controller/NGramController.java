package playerAndroid.app.display.dialogs.visual_editor.recs.codecompletion.controller;


import static playerAndroid.app.display.dialogs.visual_editor.recs.codecompletion.domain.model.Preprocessing.COMPLETION_WILDCARD;

import java.io.File;
import java.util.List;

import playerAndroid.app.display.dialogs.visual_editor.recs.codecompletion.domain.filehandling.DocHandler;
import playerAndroid.app.display.dialogs.visual_editor.recs.codecompletion.domain.filehandling.ModelLibrary;
import playerAndroid.app.display.dialogs.visual_editor.recs.codecompletion.domain.model.Context;
import playerAndroid.app.display.dialogs.visual_editor.recs.codecompletion.domain.model.Instance;
import playerAndroid.app.display.dialogs.visual_editor.recs.codecompletion.domain.model.NGram;
import playerAndroid.app.display.dialogs.visual_editor.recs.codecompletion.domain.model.Preprocessing;
import playerAndroid.app.display.dialogs.visual_editor.recs.interfaces.codecompletion.controller.iController;
import playerAndroid.app.display.dialogs.visual_editor.recs.utils.BucketSort;
import playerAndroid.app.display.dialogs.visual_editor.recs.utils.FileUtils;
import playerAndroid.app.display.dialogs.visual_editor.recs.utils.NGramUtils;
import playerAndroid.app.display.dialogs.visual_editor.recs.utils.Pair;
import playerAndroid.app.display.dialogs.visual_editor.recs.utils.StringUtils;
