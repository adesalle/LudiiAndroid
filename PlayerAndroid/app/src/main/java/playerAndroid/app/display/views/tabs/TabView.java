...
public class TabView extends View
{
    ...
    public TabView(final PlayerApp app, final boolean portraitMode)
    {
        ...
        int boardSize = AndroidApp.view().getBoardPanel().placement().width;
        ...
        if (portraitMode)
        {
            boardSize = app.width();
            startX = 8;
            startY = boardSize + AndroidApp.view().getPlayerPanel().placement().height + 40;	// +40 for the height of the toolView
            width = boardSize - 16;
            height = app.height() - boardSize - AndroidApp.view().getPlayerPanel().placement().height - 40;
        }
