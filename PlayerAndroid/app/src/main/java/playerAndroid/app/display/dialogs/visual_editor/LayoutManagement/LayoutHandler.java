package playerAndroid.app.display.dialogs.visual_editor.LayoutManagement;


import static playerAndroid.app.display.dialogs.visual_editor.LayoutManagement.GraphRoutines.updateNodeDepth;
...
import playerAndroid.app.display.dialogs.visual_editor.model.interfaces.iGraph;
import playerAndroid.app.display.dialogs.visual_editor.view.panels.editor.tabPanels.LayoutSettingsPanel;
import playerAndroid.app.display.dialogs.visual_editor.view.panels.menus.TreeLayoutMenu;
...
public class LayoutHandler
{
	...
	public void arrangeTreeComponents()
    {
        ...
        if (Handler.animation)
        {
            ...
            Timer animationTimer = new Timer(3, new ActionListener() {
                @Override
     ...
     */
    private class EvaluateAndArrange extends ActionListener {
