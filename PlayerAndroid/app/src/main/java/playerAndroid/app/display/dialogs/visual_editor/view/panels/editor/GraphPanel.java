...
import playerAndroid.app.display.dialogs.visual_editor.LayoutManagement.GraphRoutines;
import playerAndroid.app.display.dialogs.visual_editor.LayoutManagement.LayoutHandler;
import playerAndroid.app.display.dialogs.visual_editor.LayoutManagement.Vector2D;
...
import playerAndroid.app.display.dialogs.visual_editor.model.interfaces.iGNode;
import playerAndroid.app.display.dialogs.visual_editor.view.components.AddArgumentPanel;
import playerAndroid.app.display.dialogs.visual_editor.view.components.ludemenodecomponent.LudemeNodeComponent;
import playerAndroid.app.display.dialogs.visual_editor.view.components.ludemenodecomponent.inputs.LConnectionComponent;
import playerAndroid.app.display.dialogs.visual_editor.view.components.ludemenodecomponent.inputs.LIngoingConnectionComponent;
import playerAndroid.app.display.dialogs.visual_editor.view.components.ludemenodecomponent.inputs.LInputArea;
...
import playerAndroid.app.display.dialogs.visual_editor.view.panels.editor.selections.FixedGroupSelection;
import playerAndroid.app.display.dialogs.visual_editor.view.panels.editor.selections.SelectionBox;
   ...
   // private final List<Long> latencies = new ArrayList<>();
    ...
    private final MouseAdapter panelDragListener = new MouseAdapter()
    {
        ...
        public void mouseDragged(MouseEvent e)
        {
            ...
            {
                Component viewPort = (Component) SwingUtilities.getAncestorOfClass(Component.class, GraphPanel.this);
                if (viewPort != null)
                {
    ...
    public void paintComponent(Graphics g)
    {
        ...
        if(getBackground() != new ColorDrawable(DesignPalette.BACKGROUND_EDITOR().toArgb()))
