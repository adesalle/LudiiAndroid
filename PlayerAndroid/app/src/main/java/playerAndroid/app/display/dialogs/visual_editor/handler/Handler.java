package playerAndroid.app.display.dialogs.visual_editor.handler;
...
import playerAndroid.app.display.dialogs.visual_editor.model.Edge;
...
import playerAndroid.app.display.dialogs.visual_editor.model.UserActions.ActivateOptionalTerminalAction;
import playerAndroid.app.display.dialogs.visual_editor.model.UserActions.AddedCollectionAction;
import playerAndroid.app.display.dialogs.visual_editor.model.UserActions.AddedConnectionAction;
import playerAndroid.app.display.dialogs.visual_editor.model.UserActions.AddedNodeAction;
import playerAndroid.app.display.dialogs.visual_editor.model.UserActions.ChangedClauseAction;
import playerAndroid.app.display.dialogs.visual_editor.model.UserActions.CollapsedAction;
import playerAndroid.app.display.dialogs.visual_editor.model.UserActions.IUserAction;
import playerAndroid.app.display.dialogs.visual_editor.model.UserActions.PasteAction;
import playerAndroid.app.display.dialogs.visual_editor.model.UserActions.RemovedCollectionAction;
import playerAndroid.app.display.dialogs.visual_editor.model.UserActions.RemovedConnectionAction;
import playerAndroid.app.display.dialogs.visual_editor.model.UserActions.RemovedNodeAction;
import playerAndroid.app.display.dialogs.visual_editor.model.UserActions.RemovedNodesAction;
import playerAndroid.app.display.dialogs.visual_editor.view.VisualEditorFrame;
...
import playerAndroid.app.display.dialogs.visual_editor.view.panels.editor.backgrounds.CartesianGridBackground;
import playerAndroid.app.display.dialogs.visual_editor.view.panels.editor.backgrounds.DotGridBackground;
import playerAndroid.app.display.dialogs.visual_editor.view.panels.editor.backgrounds.EmptyBackground;
import playerAndroid.app.display.dialogs.visual_editor.view.panels.editor.backgrounds.IBackground;
import playerAndroid.app.display.dialogs.visual_editor.view.panels.editor.defineEditor.DefineEditor;
import playerAndroid.app.display.dialogs.visual_editor.view.panels.editor.defineEditor.DefineGraphPanel;
import playerAndroid.app.display.dialogs.visual_editor.view.panels.editor.gameEditor.GameGraphPanel;
import playerAndroid.app.display.dialogs.visual_editor.view.panels.editor.tabPanels.LayoutSettingsPanel;
import playerAndroid.app.display.dialogs.visual_editor.view.panels.header.ToolsPanel;
...
public class Handler
{
    ...
    public static Object[] compile(boolean openDialog)
    {
        ...
        if(output[0] == null && openDialog)
        {
			...
			List<String> errors = (List<String>) output[1];
            String errorMessage;
            if (errors.isEmpty())
            {
