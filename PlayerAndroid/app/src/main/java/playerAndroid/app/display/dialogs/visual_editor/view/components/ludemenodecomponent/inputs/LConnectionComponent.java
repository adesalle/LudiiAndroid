...
public class LConnectionComponent extends JComponent
{
    ...
    public void updatePosition()
    {
        ...
        int x = (int) (connectionPointComponent.getX() + this.getX() + ((ViewGroup) this.getParent()).getX() + ((ViewGroup) this.getParent().getParent()).getX() + ((ViewGroup) this.getParent().getParent()).getX() + radius());
        int y = (int) (connectionPointComponent.getY() + this.getY() + ((ViewGroup) this.getParent()).getY() + ((ViewGroup) this.getParent().getParent()).getY() + ((ViewGroup) this.getParent().getParent()).getY() + radius());
    ...
    class ConnectionPointComponent extends JComponent
    {
        ...
        public void paintComponent(Graphics g)
        {
            ...
            if(fill)
            {
                g.setColor(DesignPalette.LUDEME_CONNECTION_POINT());
            ...
            else
            {
                ...
                {
                    g.setColor(DesignPalette.LUDEME_CONNECTION_POINT_INACTIVE());
                }
                else
                {
                    g.setColor(DesignPalette.LUDEME_CONNECTION_POINT());
                ...
                g.setColor(DesignPalette.BACKGROUND_LUDEME_BODY());
