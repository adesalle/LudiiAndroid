...
public class LudemeNodeComponent extends JPanel
{
    ...
    final MouseMotionListener dragListener = new MouseAdapter()
    {
        ...
        public void mouseDragged(MouseEvent e)
        {
            ...
            e.translatePoint((int) (e.getComponent().getX() - LudemeNodeComponent.this.x), (int) (e.getComponent().getY() - LudemeNodeComponent.this.y));
    ...
    final MouseListener mouseListener = new MouseAdapter()
    {
        ...
        public void mousePressed(MouseEvent e)
        {
            ...
            Handler.updatePosition(node(), (int) getX(), (int) getY());
            handleNodeComponentSelection(e);
        }
	...
	void handleNodeComponentSelection(MouseEvent e)
    {
        ...
        LayoutSettingsPanel.getLayoutSettingsPanel().setSelectedComponent((String) LudemeNodeComponent.this.header.title().getText(), subtree);
    }
