		...
		{
			{
				...
				final ActionListener listener_1 = new ActionListener()
				{
					...
					{
						testLudemeString(app, textPane_1.getText().toString());
					}
				};
				...
				final ActionListener listener_2 = new ActionListener()
				{
					...
					public void actionPerformed(final ActionEvent e)
					{
						testLudemeString(app, textPane_2.getText().toString());
					}
				};
				...
				final ActionListener listener_3 = new ActionListener()
				{
					...
					public void actionPerformed(final ActionEvent e)
					{
						testLudemeString(app, textPane_3.getText().toString());
					}
				};
				...
				final ActionListener listener_4 = new ActionListener()
				{
					...
					public void actionPerformed(final ActionEvent e)
					{
						testLudemeString(app, textPane_4.getText().toString());
					}
				};
				...
				final ActionListener listener_5 = new ActionListener()
				{
					...
					public void actionPerformed(final ActionEvent e)
					{
						testLudemeStringConcepts(app, String.valueOf(textPane_1.getText()));
					}
				};
				...
				final ActionListener listener_6 = new ActionListener()
				{
					...
					public void actionPerformed(final ActionEvent e)
					{
						testLudemeStringConcepts(app, String.valueOf(textPane_2.getText()));
					}
				};
				...
				final ActionListener listener_7 = new ActionListener()
				{
					...
					public void actionPerformed(final ActionEvent e)
					{
						testLudemeStringConcepts(app, String.valueOf(textPane_3.getText()));
					}
				};
				...
				final ActionListener listener_8 = new ActionListener()
				{
					...
					public void actionPerformed(final ActionEvent e)
					{
						testLudemeStringConcepts(app, String.valueOf(textPane_4.getText()));
					}
				};
				...
				final DocumentListener listenerText_1 = new DocumentListener()
				{
					...
					public void changedUpdate(final DocumentEvent e)
					{
						...
						app.settingsPlayer().setTestLudeme1(String.valueOf(textPane_1.getText()));
					}
				...
				final DocumentListener listenerText_2 = new DocumentListener()
				{
					...
					public void changedUpdate(final DocumentEvent e)
					{
						...
						app.settingsPlayer().setTestLudeme2(String.valueOf(textPane_2.getText()));
					}
				...
				final DocumentListener listenerText_3 = new DocumentListener()
				{
					...
					public void changedUpdate(final DocumentEvent e)
					{
						...
						app.settingsPlayer().setTestLudeme3(String.valueOf(textPane_3.getText()));
					}
				...
				final DocumentListener listenerText_4 = new DocumentListener()
				{
					...
					public void changedUpdate(final DocumentEvent e)
					{
						...
						app.settingsPlayer().setTestLudeme4(String.valueOf(textPane_4.getText()));
					}
