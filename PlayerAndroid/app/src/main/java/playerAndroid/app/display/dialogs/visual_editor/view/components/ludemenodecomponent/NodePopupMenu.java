...
public class NodePopupMenu extends JPopupMenu
{
	...
	public NodePopupMenu(LudemeNodeComponent nodeComponent, IGraphPanel graphPanel)
    {
        ...
        collapse.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent event) {Handler.collapseNode(graphPanel.graph(), nodeComponent.node(), true);}});
        ...
        if(nodeComponent.node().isDefineRoot())
        {
            ...
            removeDefine.addActionListener(new ActionListener() {
                                               @Override
                                               public void actionPerformed(ActionEvent event) {
