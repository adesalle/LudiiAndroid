...
import playerAndroid.app.display.dialogs.visual_editor.LayoutManagement.GraphAnimator;
import playerAndroid.app.display.dialogs.visual_editor.handler.Handler;
import playerAndroid.app.display.dialogs.visual_editor.view.panels.editor.EditorSidebar;
import playerAndroid.app.display.dialogs.visual_editor.view.panels.editor.tabPanels.LayoutSettingsPanel;
import playerAndroid.app.display.dialogs.visual_editor.view.panels.userGuide.LayoutUserGuideFrame;
...
public class TreeLayoutMenu extends JMenu
{
    ...
    public TreeLayoutMenu(EditorMenuBar menuBar)
    {
        ...
        EditorMenuBar.addJCheckBoxMenuItem(this, "Animation", Handler.animation, new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        EditorMenuBar.addJCheckBoxMenuItem(this, "Auto Placement", Handler.autoplacement, new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        EditorMenuBar.addJCheckBoxMenuItem(this, "Preserve Configurations", Handler.autoplacement, new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Handler.evaluateLayoutMetrics = ((JCheckBoxMenuItem) e.getSource()).isSelected();
            }
        });

        add(new JSeparator());

        EditorMenuBar.addJMenuItem(this, "Open Layout Settings", new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        EditorMenuBar.addJMenuItem(this, "Help", new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
