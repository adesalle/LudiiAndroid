...
public final class OpenLoopNode extends BaseNode {
     ...
     */
    protected ThreadLocal<Context> currentItContext = ThreadLocal.withInitial(() -> {
        return null;
    });
     ...
     */
    protected ThreadLocal<FastArrayList<Move>> currentLegalMoves = ThreadLocal.withInitial(() -> {
        return null;
    });
     ...
     */
    protected ThreadLocal<FVector> learnedSelectionPolicy = ThreadLocal.withInitial(() -> {
        return null;
    });
     ...
     */
    protected ThreadLocal<OpenLoopNode[]> moveIdxToNode = ThreadLocal.withInitial(() -> {
        return null;
    });
     ...
     */
    protected ThreadLocal<Float> logit = ThreadLocal.withInitial(() -> {
