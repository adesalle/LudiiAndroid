...
public class ResultsSummary {
     ...
     *
     * @param agentPermutation Array giving us the original agent index for every player index 1 <= p <= numPlayers
     * @param utilities        Array of utilities for the players
     * @param gameDuration     Number of moves made in the game
     */
