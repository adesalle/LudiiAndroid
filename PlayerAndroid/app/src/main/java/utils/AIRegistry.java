...
public class AIRegistry {
    ...
    static {
        ...
        registerAI("Human", -1, (game) -> {
            return false;
        }, null);    // We have special handling for human in dropdown menus
        registerAI("Ludii AI", -1, (game) -> {
            return true;
        }, null);
        registerAI("Random", 1, (game) -> {
            return new RandomAI().supportsGame(game);
        }, null);
        registerAI("Flat MC", 2, (game) -> {
            return new FlatMonteCarlo().supportsGame(game);
        }, null);
        registerAI("UCT", 3, (game) -> {
            return MCTS.createUCT().supportsGame(game);
        }, null);
        registerAI("UCT (Uncapped)", 4, (game) -> {
            return MCTS.createUCT().supportsGame(game);
        }, null);
        registerAI("MC-GRAVE", 5, (game) -> {
            return AIFactory.createAI("MC-GRAVE").supportsGame(game);
        }, null);
        registerAI("Progressive History", 6, (game) -> {
            return AIFactory.createAI("Progressive History").supportsGame(game);
        }, null);
        registerAI("MAST", 7, (game) -> {
            return AIFactory.createAI("MAST").supportsGame(game);
        }, null);
        registerAI("Biased MCTS", 8, (game) -> {
            return MCTS.createBiasedMCTS(0.0).supportsGame(game);
        }, null);
        registerAI("MCTS (Biased Selection)", 9, (game) -> {
            return MCTS.createBiasedMCTS(1.0).supportsGame(game);
        }, null);
        registerAI("Alpha-Beta", 10, (game) -> {
            return AlphaBetaSearch.createAlphaBeta().supportsGame(game);
        }, null);
        registerAI("BRS+", 11, (game) -> {
            return new BRSPlus().supportsGame(game);
        }, null);
        registerAI("MCTS (Hybrid Selection)", 12, (game) -> {
            return MCTS.createHybridMCTS().supportsGame(game);
        }, null);
        registerAI("Bandit Tree Search", 13, (game) -> {
            return MCTS.createBanditTreeSearch().supportsGame(game);
        }, null);
        registerAI("NST", 14, (game) -> {
            return AIFactory.createAI("NST").supportsGame(game);
        }, null);
        registerAI("UCB1Tuned", 15, (game) -> {
            return AIFactory.createAI("UCB1Tuned").supportsGame(game);
        }, null);
        registerAI("Progressive Bias", 16, (game) -> {
            return AIFactory.createAI("Progressive Bias").supportsGame(game);
        }, null);
        registerAI("EPT", 17, (game) -> {
            return AIFactory.createAI("EPT").supportsGame(game);
        }, null);
        registerAI("EPT-QB", 18, (game) -> {
            return AIFactory.createAI("EPT-QB").supportsGame(game);
        }, null);
        registerAI("Score Bounded MCTS", 19, (game) -> {
            return AIFactory.createAI("Score Bounded MCTS").supportsGame(game);
        }, null);
        registerAI("Heuristic Sampling", 20, (game) -> {
            return AIFactory.createAI("Heuristic Sampling").supportsGame(game);
        }, null);
        registerAI("One-Ply (No Heuristic)", 21, (game) -> {
            return AIFactory.createAI("One-Ply (No Heuristic)").supportsGame(game);
        }, null);
        //registerAI("Bob the Basic AI", 22, (game) -> {return true;}, null);
        registerAI("UBFM", 23, (game) -> {
            return AIFactory.createAI("UBFM").supportsGame(game);
        }, null);
        registerAI("Hybrid UBFM", 24, (game) -> {
            return AIFactory.createAI("Hybrid UBFM").supportsGame(game);
        }, null);
        registerAI("Biased UBFM", 25, (game) -> {
            return AIFactory.createAI("Biased UBFM").supportsGame(game);
        }, null);
        registerAI("Lazy UBFM", 26, (game) -> {
            return AIFactory.createAI("Lazy UBFM").supportsGame(game);
        }, null);
        registerAI("UCB1-GRAVE", 27, (game) -> {
            return AIFactory.createAI("UCB1-GRAVE").supportsGame(game);
        }, null);
        registerAI("From JAR", -1, (game) -> {
            return false;
        }, null);    // We have special handling for From JAR in dropdown menus
    }
    ...
    public static boolean registerAI(final String label, final AIConstructor aiConstructor) {
        return registerAI(label, -1, (game) -> {
            return true;
        }, aiConstructor);
    }
