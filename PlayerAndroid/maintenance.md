...
4.  If the update adds new functions or classes from `awt`, `swing`, or other packages not compatible with Android, they must be re-implemented for Android. Follow the same pattern used for the classes already ported.
